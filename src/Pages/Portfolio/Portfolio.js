    ...
    <div>
      <About></About>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-2">
            <a href="https://manufacturing-industry-d2077.web.app/" target="_blank" rel="noopener noreferrer"><div className="bg-white px-7 py-4 text-center w-full rounded text-5xl font-bold shadow-lg">Computer parts manufacturer</div></a>
